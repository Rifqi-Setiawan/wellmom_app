...
@JsonKey(name: 'access_token') String get accessToken;@JsonKey(name: 'token_type') String get tokenType;@JsonKey(name: 'user_id') int get userId;@JsonKey(name: 'ibu_hamil_id') int get ibuHamilId;@JsonKey(name: 'nama_lengkap') String get namaLengkap; String get email;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,tokenType,userId,ibuHamilId,namaLengkap,email);
...
@useResult
$Res call({
@JsonKey(name: 'access_token') String accessToken,@JsonKey(name: 'token_type') String tokenType,@JsonKey(name: 'user_id') int userId,@JsonKey(name: 'ibu_hamil_id') int ibuHamilId,@JsonKey(name: 'nama_lengkap') String namaLengkap, String email
});
...
/// Create a copy of LoginResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? tokenType = null,Object? userId = null,Object? ibuHamilId = null,Object? namaLengkap = null,Object? email = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'access_token')  String accessToken, @JsonKey(name: 'token_type')  String tokenType, @JsonKey(name: 'user_id')  int userId, @JsonKey(name: 'ibu_hamil_id')  int ibuHamilId, @JsonKey(name: 'nama_lengkap')  String namaLengkap,  String email)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponseModel() when $default != null:
return $default(_that.accessToken,_that.tokenType,_that.userId,_that.ibuHamilId,_that.namaLengkap,_that.email);case _:
  return orElse();
...
class _LoginResponseModel implements LoginResponseModel {
  const _LoginResponseModel({@JsonKey(name: 'access_token') required this.accessToken, @JsonKey(name: 'token_type') required this.tokenType, @JsonKey(name: 'user_id') required this.userId, @JsonKey(name: 'ibu_hamil_id') required this.ibuHamilId, @JsonKey(name: 'nama_lengkap') required this.namaLengkap, required this.email});
...
/// Create a copy of LoginResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? tokenType = null,Object? userId = null,Object? ibuHamilId = null,Object? namaLengkap = null,Object? email = null,}) {
