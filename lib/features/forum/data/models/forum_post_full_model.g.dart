...
_$ForumPostFullModelImpl _$$ForumPostFullModelImplFromJson(
...
Map<String, dynamic> _$$ForumPostFullModelImplToJson(
  _$ForumPostFullModelImpl instance,
) => <String, dynamic>{
  'id': instance.id,
...
_$ForumPostsResponseModelImpl _$$ForumPostsResponseModelImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ForumPostsResponseModelImplToJson(
  _$ForumPostsResponseModelImpl instance,
) => <String, dynamic>{
